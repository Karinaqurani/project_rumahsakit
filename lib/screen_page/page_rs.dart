...
import 'package:project_rumahsakit/model/model_rs.dart';
import 'package:project_rumahsakit/screen_page/page_detailrs.dart';
...
class _PageRumahSakitState extends State<PageRumahSakit> {
  ...
  Future<void> fetchRumahSakitData() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://10.126.15.115/rumahsakitDB/getRS.php?id_kabupaten=${widget.kabupatenId}'));
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Card(
                    ...
                    elevation: 5,
                    child: ListTile(
                      leading: Image.network('http://10.126.15.115/rumahsakitDB/gambar/${rumahSakit.gambar}', width: 100, height: 80,),
                      title: Text(
                        rumahSakit.namaRs,
                        style: TextStyle(
                          color: Colors.green,
